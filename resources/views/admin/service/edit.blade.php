                        ...
                        <div class="md:flex justify-start items-start">
                            <div class="md:w-2/5">
                                ...
                                <div class="form-group mb-4">
                                    ...
                                    <input type="text" name="name" id="name" placeholder="Type here" class="border-slate-400 input mt-1 input-bordered w-full max-w-md bg-white" value="{{ $listService->name }}" required>
                                </div>
                                <div class="form-group">
                                    <label for="description" class="block font-medium">Deskripsi</label>
                                    <textarea name="description" id="description" class="border-slate-400 textarea textarea-bordered w-full max-w-md bg-white" rows="4" placeholder="Type here">{{ $listService->description }}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="md:w-3/5 md:pl-5">
                                <div class="form-group mb-4">
                                    ...
                                    <input type="text" name="time_estimate" id="time_estimate" placeholder="Type here" class="border-slate-400 input mt-1 input-bordered w-full max-w-md bg-white" value="{{ $listService->time_estimate }}" required>
                                </div>
                                <div class="form-group mb-4">
                                    <label for="price" class="block font-medium">Estimasi Harga</label>
                                    <input type="text" name="price" id="price" placeholder="Type here" class="border-slate-400 input mt-1 input-bordered w-full max-w-md bg-white" value="{{ $listService->price }}" required>
                                </div>
