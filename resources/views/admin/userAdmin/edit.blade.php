                        ...
                        <div class="md:flex justify-start items-start mt-4">
                            ...
                            <div class="md:w-3/5">
                                ...
                                <div class="form-group mb-4">
                                    ...
                                    <textarea name="alamat" id="alamat" placeholder="Type here" class="textarea textarea-bordered w-96 mt-2 h-36 border-slate-400 bg-white" required>{{ old('alamat', $user->alamat) }}</textarea>
                                </div>
